...
export const ui = {
  fr: {
    ...
    hero: {
      ...
      availability:
        "Ouvert aux opportunités, collaborations et projets sélectionnés.",
    },
    work: {
    ...
    build: {
      ...
      cards: [
        [
          "01",
          "Conception produit",
          "Transformer une idée, un besoin ou un processus en parcours clair, en interface cohérente et en produit réellement utilisable.",
        ],
        [
          "02",
          "Web & mobile",
          "Sites, applications web et expériences mobiles conçus pour être rapides, lisibles et agréables à utiliser sur chaque écran.",
        ],
        [
          "03",
          "Applications & outils métier",
          "Applications desktop, outils internes et produits adaptés à des contextes précis, avec une affinité particulière pour l’EdTech et la mobilité.",
        ],
      ],
    },
    about: {
    ...
    stack: {
      ...
      nextBody:
        "pour prolonger naturellement React et TypeScript vers des applications mobiles natives.",
      creative: "Design & création",
      creativeTitle: "Au-delà du code.",
      creativeBody:
        "Je travaille aussi autour du design d’interface et de l’image, avec un intérêt plus large pour la vidéo et la musique. Figma, Photoshop et Inkscape sont les outils créatifs que je souhaite mettre en avant ici.",
    },
    contact: {
      eyebrow: "Contact",
      ...
      error:
        "Impossible d’envoyer le message pour le moment. Vous pouvez me contacter directement par email.",
    },
    footer: {
      tagline: "Développeur logiciel, web & mobile · France",
      legal: "Tous droits réservés.",
    },
    projects: {
      title: "Projets",
      intro:
        "Chaque projet est présenté avec son contexte, sa conception, ses fonctionnalités et les choix techniques qui l’ont façonné.",
    ...
    project: {
      ...
      gallery: "Captures du produit",
      live: "Ouvrir l'application",
  ...
  en: {
    ...
    hero: {
      ...
      availability:
        "Open to opportunities, collaborations and selected projects.",
    },
    work: {
    ...
    build: {
      ...
      cards: [
        [
          "01",
          "Product design",
          "Turn an idea, need or process into a clear flow, a coherent interface and a genuinely usable product.",
        ],
        [
          "02",
          "Web & mobile",
          "Websites, web applications and mobile experiences designed to stay fast, clear and enjoyable on every screen.",
        ],
        [
          "03",
          "Applications & business tools",
          "Desktop applications, internal tools and products shaped around specific contexts, with a particular interest in EdTech and mobility.",
        ],
      ],
    },
    about: {
    ...
    stack: {
      ...
      next: "Next to deepen",
      nextBody:
        "to extend React and TypeScript naturally into native mobile applications.",
      creative: "Design & creative",
      creativeTitle: "Beyond code.",
      creativeBody:
        "I also work around interface design and imagery, with a broader interest in video and music. Figma, Photoshop and Inkscape are the creative tools I want to highlight here.",
    },
    contact: {
      eyebrow: "Contact",
      ...
      error:
        "Unable to send the message right now. You can reach me directly by email instead.",
    },
    footer: {
      tagline: "Software, Web & Mobile Developer · France",
      legal: "All rights reserved.",
    },
    projects: {
      title: "Projects",
      intro:
        "Each project is presented through its context, product design, key features and the technical choices that shaped it.",
